...
export const REPO_URL = 'https://github.com/VDERR/dsh-echocat-skill-panel'
export const RELEASES_URL = `${REPO_URL}/releases`
export const GITHUB_LATEST_URL = 'https://api.github.com/repos/VDERR/dsh-echocat-skill-panel/releases/latest'
...
async function getJson(fetchImpl, url, headers = {}) {
  ...
  try {
    ...
    response = await fetchImpl(url, {
      headers: { accept: 'application/json', 'user-agent': `dsh-echocat-skill-panel/${VERSION}`, ...headers },
      signal,
      redirect: 'follow',
    })
  } catch (error) {
