// dsh-echocat-skill-panel — per-turn skill-usage audit (host half).
//
...
//   * Package renamed to the all-lowercase `dsh-echocat-skill-panel`: npm-style
...
export const name = 'dsh-echocat-skill-panel'
...
function mount(ctx, config) {
  ...
  ctx.inject(['sessions'], (sessionsCtx) => {
    ...
    }, 'dsh-echocat-skill-panel: turn skill audit')
  })
  ...
  ctx.inject(['skills'], (skillsCtx) => {
    ...
    }, 'dsh-echocat-skill-panel: skills handle')
  })
  ...
  ctx.inject(['agents'], (agentsCtx) => {
    ...
    }, 'dsh-echocat-skill-panel: agents handle')
  })
  ...
  ctx.inject(['llm'], (llmCtx) => {
    ...
    }, 'dsh-echocat-skill-panel: llm handle')
  })
  let defaultModel
  ctx.inject(['agentDefaultModel'], (modelCtx) => {
    ...
    }, 'dsh-echocat-skill-panel: default model handle')
  })
  ...
  if (httpRoute === true) {
    ctx.inject(['connection'], (connectionCtx) => {
      ...
      }, 'dsh-echocat-skill-panel: panel feed')
    })
  } else {
