...
const DESIGN = Object.freeze([
  ...
  /* ============================ 5. frame ============================ */
  D('frame-radius', 'frame', '.sr-root', { borderRadius: 22 },
  ...
  D('hero-radius', 'hero', '.sr-hero', { borderRadius: 22 },
  ...
  D('stat-radius', 'stat', '.sr-stat', { borderRadius: 22 },
  ...
  /* ============================ 10. cards ============================ */
  D('card-radius', 'card', '.sr-skill', { borderRadius: 22 },
  ...
  /* ============================ 13. toasts ============================ */
  D('toast-radius', 'toast', '.sr-toast', { borderRadius: 22, fontSize: 12, padding: 'calc(var(--sr-u) * 2.5) calc(var(--sr-u) * 3)' },
  ...
  /* ============================ 14. sheet ============================ */
  D('sheet-radius', 'sheet', '.sr-sheet', { borderRadius: 22 },
  ...
  D('guide-radius', 'sec', '.sr-guide', { borderRadius: 22, borderStyle: 'dashed', borderWidth: 1.5, background: 'var(--sr-raised)' },
  ...
  D('skeleton-radius', 'sec', '.sr-skel--card', { height: 62, borderRadius: 22 },
  ...
  D('r-radius-card', 'card', '.sr-skill', { borderRadius: 22 },
  ...
  D('r-root-radius', 'frame', '.sr-root', { borderRadius: 22 },
  ...
  D('r-hero-radius', 'hero', '.sr-hero', { borderRadius: 22 },
  ...
  D('r-toast-radius', 'toast', '.sr-toast', { borderRadius: 22 },
  ...
  D('r-sheet-radius', 'sheet', '.sr-sheet', { borderRadius: 22 },
  ...
  D('r-skel-radius', 'frame', '.sr-skel', { borderRadius: 22 },
  ...
  D('r-empty-rule', 'sec', '.sr-empty', { border: '1px dashed var(--sr-line)', borderRadius: 22 },
  ...
  D('r-round-hero', 'hero', '.sr-hero', { borderRadius: 22 },
    'the hero takes the one radius, like every other surface'),
  D('r-round-stat', 'stat', '.sr-stat', { borderRadius: 22 },
    'the stat cards take it too'),
  D('r-round-toast', 'toast', '.sr-toast', { borderRadius: 22 },
  ...
  D('claim-inner', 'card', '.sr-claim-row .sr-claim', { padding: 0, background: 'none', borderRadius: 22, borderTop: 0, marginTop: 0 },
